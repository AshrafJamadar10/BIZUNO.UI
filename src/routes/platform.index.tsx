...
function PlatformDashboard() {
  ...
  const active = tenants.filter((tenant) => tenant.status === "active").length; const mrr = packages.reduce((sum, pkg) => sum + (pkg.billingPeriod === "MONTHLY" ? pkg.basePrice : 0) * pkg.activeTenants, 0);
