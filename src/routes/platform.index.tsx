...
export const Route = createFileRoute("/platform/")({ beforeLoad: () => { if (window.localStorage.getItem("bizuno-demo-role") !== "PlatformAdmin") throw redirect({ to: "/platform/login" }); }, component: PlatformDashboard });
