...
export const Route = createFileRoute("/platform/subscriptions")({ beforeLoad: () => { if (window.localStorage.getItem("bizuno-demo-role") !== "PlatformAdmin") throw redirect({ to: "/platform/login" }); }, component: SubscriptionsPage });
